...
import org.secretflow.secretpad.manager.integration.model.DatasourceDTO.NodeDatasourceId;
...
public abstract class AbstractDatasourceManager {
    ...
    public abstract Optional<DatasourceDTO> findById(NodeDatasourceId from);
}
