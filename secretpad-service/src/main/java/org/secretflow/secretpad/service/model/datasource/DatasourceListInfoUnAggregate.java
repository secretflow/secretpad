...
@AllArgsConstructor
@NoArgsConstructor
public class DatasourceListInfoUnAggregate {
    ...
    public static DatasourceListInfoUnAggregate from(Domaindatasource.DomainDataSource datasourceInfo) {
        return DatasourceListInfoUnAggregate.builder()
