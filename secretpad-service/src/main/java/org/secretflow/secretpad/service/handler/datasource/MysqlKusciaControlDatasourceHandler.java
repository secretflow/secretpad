...
@Slf4j
@Service
public class MysqlKusciaControlDatasourceHandler extends AbstractDatasourceHandler {
    @Resource
    @Setter
    ...
    public CreateDatasourceVO createDatasource(CreateDatasourceRequest createDatasourceRequest) {
        MysqlDatasourceInfo info = (MysqlDatasourceInfo) createDatasourceRequest.getDataSourceInfo();
        MysqlConfig mysqlConfig = info.toMysqlConfig();
        mysqlManager.testConnection(mysqlConfig);
    ...
    private CreateDatasourceVO createDatasourceInKuscia(CreateDatasourceRequest createDatasourceRequest, MysqlDatasourceInfo info) {
        ...
        String datasourceId = DomainDatasourceConstants.DATASOURCE_MYSQL_ID_PREFIX.concat(UUIDUtils.random(16));
